---
aliases: [2021 - AN IMAGE IS WORTH 16X16 WORDS - Transformers for I...]
tags:
  - grupo/g4_imágenes
  - estado/archivo
  - tipo/documento
...
ruta_interna: "GIBD/Papers/ViT/2021 - AN IMAGE IS WORTH 16X16 WORDS - Transformers for Image Recognition at Scale.pdf"
tamanio_bytes: 3743814
---

# 2021 - AN IMAGE IS WORTH 16X16 WORDS - Transformers for Image Recognition at Scale

Ruta interna: `GIBD/Papers/ViT/2021 - AN IMAGE IS WORTH 16X16 WORDS - Transformers for Image Recognition at Scale.pdf`
...
2015) withβ1 = 0.9,β2 = 0.999, a batch size of 4096 and apply a high weight decay of 0.1, which
...
parameters constant when changingk,Dh (Eq. 5) is typically set toD/k.
MSA(z) = [SA 1(z); SA2(z);··· ; SAk(z)] Umsa Umsa∈ Rk·Dh×D (8)
...
for different conﬁgurations. All conﬁgurations are based on a ViT model with8 layers,D = 1024,
