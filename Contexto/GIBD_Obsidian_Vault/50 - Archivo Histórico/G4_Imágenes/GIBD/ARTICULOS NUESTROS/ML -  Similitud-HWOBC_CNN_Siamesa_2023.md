---
aliases: [ML -  Similitud-HWOBC_CNN_Siamesa_2023]
tags:
  - grupo/g4_imágenes
  - estado/archivo
  - tipo/notebook
...
ruta_interna: "GIBD/ARTICULOS NUESTROS/2023 - CONAIISI/Caracteres Chinos/ML -  Similitud-HWOBC_CNN_Siamesa_2023.ipynb"
tamanio_bytes: 56319
---

# Notebook: ML -  Similitud-HWOBC_CNN_Siamesa_2023.ipynb

Ruta interna: `GIBD/ARTICULOS NUESTROS/2023 - CONAIISI/Caracteres Chinos/ML -  Similitud-HWOBC_CNN_Siamesa_2023.ipynb`
...
**[Celda 2 - Código]**
```python
# SIAMESA 07/08/2023 - Ultima actualización
...
# Ejemplo de uso
#ruta_carpeta_principal = '/content/drive/MyDrive/Grupo Investigación /Selección de Prueba'
#nombre_imagen = '60A03_13.JPG'
#ruta_imagen = buscar_imagen(ruta_carpeta_principal, nombre_imagen)
#if ruta_imagen:
#    print(f"La imagen se encuentra en la siguiente ruta: {ruta_imagen}")
#else:
#    print("La imagen no se encuentra en la carpeta principal o en sus subcarpetas.")
```
...
pares_imagenes_distintos = obtener_pares_imagenes(ruta_carpeta_principal, 200)
pares_imagenes = obtener_pares_imagenes_similares(ruta_carpeta_principal, 200)
...
directorio = '/content/drive/MyDrive/Grupo Investigación /Queries_CaracteresChinos'
contenido = os.listdir(directorio)
print(contenido)
consultas = []
y_consultas = []
