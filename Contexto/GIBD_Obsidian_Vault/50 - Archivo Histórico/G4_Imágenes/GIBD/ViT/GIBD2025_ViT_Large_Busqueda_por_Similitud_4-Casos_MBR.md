---
aliases: [GIBD2025_ViT_Large_Busqueda_por_Similitud_4-Casos_MBR]
tags:
  - grupo/g4_imágenes
  - estado/archivo
  - tipo/notebook
...
ruta_interna: "GIBD/ViT/GIBD2025_ViT_Large_Busqueda_por_Similitud_4-Casos_MBR.ipynb"
tamanio_bytes: 72608278
---

# Notebook: GIBD2025_ViT_Large_Busqueda_por_Similitud_4-Casos_MBR.ipynb

Ruta interna: `GIBD/ViT/GIBD2025_ViT_Large_Busqueda_por_Similitud_4-Casos_MBR.ipynb`
...
```python
def buscar_similares(imagen_consulta, embeddings_base, nombres_base, mode, pooling, layers, device, top_k=5):
    """Devuelve top_k imágenes más similares usando distancia euclídea."""
    emb_consulta = extract_embedding(imagen_consulta, mode=mode, pooling=pooling, layers=layers, device=device)
    distancias = euclidean_distances([emb_consulta], embeddings_base)[0]
    indices = np.argsort(distancias)[:top_k]
    return [(nombres_base[i], distancias[i]) for i in indices]
```
...
*Salida:*
```text
100%|██████████| 10391/10391 [04:16<00:00, 40.57it/s]
⏱️ Tiempo construcción embeddings base: 283.81 s
🔍 Consulta 1: 1.png
...
⏱️ Tiempo embeddings base: 283.81 s
⏱️ Tiempo promedio búsqueda: 10.4558 s por consulta
