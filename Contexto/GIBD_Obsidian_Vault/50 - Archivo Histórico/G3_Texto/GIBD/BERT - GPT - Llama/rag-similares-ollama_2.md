...
ruta_interna: "GIBD/BERT - GPT - Llama/Artículo CONAISI 2024/Notebooks/rag-similares-ollama.ipynb"
tamanio_bytes: 430273
---

# Notebook: rag-similares-ollama.ipynb

Ruta interna: `GIBD/BERT - GPT - Llama/Artículo CONAISI 2024/Notebooks/rag-similares-ollama.ipynb`
...
def mostrar_preguntas_por_posicion(df):
    ...
    respuestas_correctas_acumuladas = 0
    ...
    for posicion in range(1, len(articulos)):
        ...
        respuestas_correctas_acumuladas += cantidad

        nDCGTot += cantidad / math.log2(posicion + 1)

        if posicion >= 1 and posicion <= 5:
            print(f"Posición {posicion}: {cantidad} (Respuestas correctas acumuladas: {respuestas_correctas_acumuladas}) (Porcentaje correctas acumuladas: {round(int(respuestas_correctas_acumuladas*100)/300,2)})")
