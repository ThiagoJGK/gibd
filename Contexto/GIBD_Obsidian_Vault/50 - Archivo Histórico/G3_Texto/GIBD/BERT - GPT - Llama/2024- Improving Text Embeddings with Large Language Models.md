---
aliases: [2024- Improving Text Embeddings with Large Language Models]
tags:
  - grupo/g3_texto
  - estado/archivo
  - tipo/documento
...
ruta_interna: "GIBD/BERT - GPT - Llama/Papers/Referencias/2024- Improving Text Embeddings with Large Language Models.pdf"
tamanio_bytes: 506422
---

# 2024- Improving Text Embeddings with Large Language Models

Ruta interna: `GIBD/BERT - GPT - Llama/Papers/Referencias/2024- Improving Text Embeddings with Large Language Models.pdf`
...
arXiv:2401.00368v3  [cs.CL]  31 May 2024
...
inst, ni))
(2)
where N denotes the set of all negatives, andϕ(q, d)
...
Figure 2: Task type and language statistics of the generated synthetic data (see Section 3.1 for task type definitions).
...
random position. The task is to retrieve the document that contains the given person’s passkey from100 candidates.
...
EmotionClassification Classify the emotion expressed in the given Twitter message into one of the six emotions:
